...
// Vérifier si un cookie d’authentification existe déjà
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Vérification simple du nom d'utilisateur et mot de passe
    if ($username === 'admin' && $password === 'secret') {

        // 🔥 EXERCICE 2 : générer un token unique
...
<body>
    ...
    <h3>
        ...
        avec le login <strong>admin</strong> et mot de passe <strong>secret</strong>.
    </h3>
